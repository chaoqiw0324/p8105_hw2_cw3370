...
number of national politicians who are democratic or republican from
year 1947 to
year`r`max(select(pols\_month\_df,year))`, Standard & Poor’s stock market index (S&P) from year 1950 to year`r
`max(select(snp_df,year))`,percentage of unemployment from year1948 to
year 2015.
